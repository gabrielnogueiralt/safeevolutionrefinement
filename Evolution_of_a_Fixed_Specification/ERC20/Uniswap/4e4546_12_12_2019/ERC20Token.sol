...
contract ERC20 is IERC20 {
    ...
    bytes32 public constant APPROVE_TYPEHASH_ =
        0x25a0822e8c2ed7ff64a57c55df37ff176282195b9e0c9bb770ed24a300c89762;
    ...
    /**
     * @natural_language
     * @description Transfer tokens from the `from` address to the `to` address, using the allowance mechanism.
    ...
    function transferFrom(
        ...
        if (allowance_[from][msg.sender] != uint(-1)) {
            allowance_[from][msg.sender] = allowance_[from][msg.sender].sub(
                value
            );
        }
